...
var getAllMovies = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, (0, movieService_1.getMovies)()];
            case 1:
                movies = _a.sent();
                res.json(movies);
                return [2 /*return*/];
...
var createMovie = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var movie;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, (0, movieService_1.createNewMovie)(req.body)];
            case 1:
                movie = _a.sent();
                res.json(movie);
                return [2 /*return*/];
...
var updateMovie = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, (0, movieService_1.updateMovieById)(Number(req.params.id), req.body)];
            case 1:
                movie = _a.sent();
                res.json(movie);
                return [2 /*return*/];
...
var deleteMovie = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, (0, movieService_1.deleteMovieById)(Number(req.params.id))];
            case 1:
                _a.sent();
                res.sendStatus(204);
                return [2 /*return*/];
